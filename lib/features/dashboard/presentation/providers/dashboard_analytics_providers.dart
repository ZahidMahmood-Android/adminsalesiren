...
final dashboardAnalyticsProvider =
    StreamProvider.autoDispose<DashboardAnalytics>((ref) {
      final firestore = ref.watch(firestoreProvider);
      return firestore.collection('offers').snapshots().asyncMap((
        offers,
      ) async {
        ...
        return DashboardAnalytics(
          ...
          rejectedOffers: items
              ...
              .length,
          verifiedOffers: items
              .where((item) => item['isVerified'] == true)
              .length,
          featuredOffers: items
